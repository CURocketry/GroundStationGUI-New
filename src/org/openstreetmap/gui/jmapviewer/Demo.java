...
public class Demo extends JFrame implements JMapViewerEventListener  {
    ...
    public Demo() {
        ...
        tabbedPane.addTab("Tab 1", null, panel, "1");
        tabbedPane.addTab("Tab2", null, panelTop, "2");
        tabbedPane.addTab("Tab3", null, panelBottom, "3");
        tabbedPane.addTab("Tab4", null, helpPanel, "4");
