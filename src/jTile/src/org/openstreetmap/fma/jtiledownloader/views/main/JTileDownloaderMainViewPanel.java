...
import jTile.src.org.openstreetmap.fma.jtiledownloader.Constants;
import jTile.src.org.openstreetmap.fma.jtiledownloader.config.AppConfiguration;

public class JTileDownloaderMainViewPanel
    extends JPanel
{
    private static final long serialVersionUID = 1L;
    private static final Logger log = Logger.getLogger(JTileDownloaderMainViewPanel.class.getName());
    private final JFrame _mainView;
    ...
    public JTileDownloaderMainViewPanel(JFrame mainView)
    {
        super();
        _mainView = mainView;
    ...
    protected final JFrame getMainView()
    {
        return _mainView;
    }
